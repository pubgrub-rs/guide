...
- [Advanced usage and limitations](advanced/intro.md)
  - [Optional dependencies](advanced/optional_deps.md)
  - [Allowing multiple versions of a package](advanced/multiple_versions.md)
  - [Public and Private packages](advanced/public_private.md)
  - [Pre-release versions](advanced/prerelease_versions.md)
